...
from app.routers import health, sessions, auth, static, audio_poc, user, audio
...
app.include_router(audio.audio_health_router)

logger.info("All routers registered (including user, audio PoC, and production audio)")
